...
namespace Nalarium.Web.Processing
{
    ...
    /// </summary>
    [System.Diagnostics.DebuggerDisplay("{Name}, {PathSegment}, {RelativePath}")]
    public class WebDomain
    {
        ...
        public String[] PathPartArray
        {
            get
            {
                return RelativePath.ToLower(System.Globalization.CultureInfo.CurrentCulture).Split('/').Where(p => !String.IsNullOrEmpty(p)).ToArray();
            }
        }

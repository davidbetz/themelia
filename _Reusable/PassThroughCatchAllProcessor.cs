...
{
    /// <summary>
    /// Used to pass all requests in a web domain directly back to IIS without setting any HTTP handler
    /// </summary>
    public class PassThroughCatchAllProcessor : CatchAllProcessorBase
    {
        //- @GetHandler -//
        /// <summary>
